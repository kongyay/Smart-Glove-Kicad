...
int  DataReturned_x0, DataReturned_x1, DataModified_x_out,DataReturned_y0, DataReturned_y1, DataModified_y_out,DataReturned_z0, DataReturned_z1, DataModified_z_out;
float x,y,z;

void setup()
{

  Serial.begin(9600); // เปิดการเชื่อมต่อ Serial เพื่อแสดงผลใน Arduino IDE เพื่อการ Debug
  Serial1.begin(9600); // เปิดการเชื่อมต่อ Serial ที่ต่ออยู่กัย MPU
